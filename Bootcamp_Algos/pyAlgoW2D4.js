...
return whether the parenthesis are valid
    -For loop that takes in a string
        -Identify parenthesis value in string
        -if count<0 return false
        -If statement that adds to count for '('
        -Another if statement that subtracts from count for ')'
*/
